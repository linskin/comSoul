...
class MyOutputWindow:
    ...
    def __information_init(self):
        ...
        self._terminators, self._non_terminators, self._production, self._start = self._extractor.extract_grammar_components(
            self._grammar_string)
        self._cleaner = GrammarCleaner()
        self._cleaned_production = self._cleaner.auto_clean(self._production, self._start)
